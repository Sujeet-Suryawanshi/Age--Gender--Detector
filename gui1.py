...
# Definig Detect function which detects the age and gender of the person in image using model
...
# Definig Uploading Image Function
def upload_image():
    try:
